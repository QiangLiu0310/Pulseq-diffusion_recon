function sMDH=ice_read_mdh_va21(fp)
...
% % typedef struct
% % {
% %   unsigned long  ulDMALength;                  // DMA length [bytes] must be                        4 byte         
% % // first parameter
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sMDH.usChannelId=fread(fp,1,'ushort');
sMDH.usPTABPosNeg=fread(fp,1,'ushort');
